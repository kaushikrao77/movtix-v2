...
const TCost = 300;
const total_number_of_movies = 20;
...
export class Movie {
  constructor(movie) {
    ...
    this.remaining_seats = movie.remaining_seats;
  ...
  update(num, val = 0) {
    switch (num) {
      ...
      case 4:
        this.remaining_seats = this.remaining_seats + 1;
    }
  }
  calculate(mainObj) {
    let dviews = 1 / (mainObj.views / no_of_movies - this.views);
